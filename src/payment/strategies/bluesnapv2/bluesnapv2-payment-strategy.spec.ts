...
describe('BlueSnapV2PaymentStrategy', () => {
    ...
    let blueSnapV2PaymentPageLoader: BlueSnapV2PaymentPageLoader;
    ...
    beforeEach(() => {
        ...
        blueSnapV2PaymentPageLoader = new BlueSnapV2PaymentPageLoader();
        blueSnapV2PaymentPageLoader.initialize({
            addFrame: jest.fn(),
            removeFrame: jest.fn(),
        });
        ...
        strategy = new BlueSnapV2PaymentStrategy(store, orderActionCreator, paymentActionCreator, blueSnapV2PaymentPageLoader);
    });
    ...
    it('returns cancel error if the user cancels flow', () => {
        jest.spyOn(blueSnapV2PaymentPageLoader, 'loadPaymentPage')

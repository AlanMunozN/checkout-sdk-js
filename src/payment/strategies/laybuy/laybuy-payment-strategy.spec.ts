...
describe('LaybuyPaymentStrategy', () => {
    ...
    describe('#execute()', () => {
        ...
        it('returns checkout state with undefined payload', () => {
            const payload = {
                payment: undefined,
            };
        ...
        it('redirect to Laybuy if external payment is required', async () => {
            const error = new RequestError(getResponse({
                ...
                provider_data: {
                    return_url: 'https://sandbox-payment.laybuy..com',
                },
                status: 'error',
            }));
        ...
        it('reject payment when error is different to external_payment_required', async () => {
